...
fir_hdl = hdlcosim_mod_full_adder;
...
for clki=1:Nclock_edges
    ...
    %-----------------------------------------------------------------
    [SumOut, Cout] = step(fir_hdl,input_vector1, input_vector2, input_vector3);  % Drive Model Sim
...
for clki=1:8
   double( matlab_history{clki})
   double (output_historySum{clki})
